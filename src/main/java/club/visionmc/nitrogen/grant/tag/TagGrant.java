...
import club.visionmc.nitrogen.event.taggrant.TagGrantSaveEvent;
...
public class TagGrant {
    ...
    public void save(){
        ...
        Document replace = new Document("uuid", this.uuid.toString())
                ...
                .append("taggrant", this.tag.getId())
        ...
        Nitrogen.getInstance().getServer().getPluginManager().callEvent(new TagGrantSaveEvent(this));
    }
