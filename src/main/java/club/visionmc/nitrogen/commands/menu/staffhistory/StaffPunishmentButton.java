...
public class StaffPunishmentButton extends Button {
    ...
    public StaffPunishmentButton(Profile profile, Punishment punishment){
    ...
    public List<String> getDescription(Player player) {
        Profile target = Nitrogen.getInstance().getProfileHandler().getProfileOrCreate(punishment.getTarget());
        ...
        description.add(Chat.format("&eTarget&7: &r" + target.getHighestRank().getColor() + target.getUsername()));
